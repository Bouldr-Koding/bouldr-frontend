...
export default function GoogleSignInButton({ className = "w-full flex items-center justify-center gap-x-3 py-2.5 border border-border rounded-lg bg-card text-card-foreground hover:bg-muted duration-150 active:bg-muted" }) {
  ...
  return (
    <button onClick={handleSignIn} className={className} type="button" aria-label="Continue with Google">
      <svg
        className="w-5 h-5"
